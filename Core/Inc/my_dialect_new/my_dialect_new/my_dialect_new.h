/** @file
 *  @brief MAVLink comm protocol generated from my_dialect_new.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_MY_DIALECT_NEW_H
#define MAVLINK_MY_DIALECT_NEW_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_MY_DIALECT_NEW.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif

#define MAVLINK_MY_DIALECT_NEW_XML_HASH -3142950522207710027
...
#define MAVLINK_MESSAGE_CRCS {{0, 50, 9, 9, 0, 0, 0}, {76, 152, 33, 33, 3, 30, 31}, {100, 60, 1, 1, 0, 0, 0}, {101, 194, 23, 23, 0, 0, 0}, {102, 134, 6, 6, 0, 0, 0}, {103, 81, 2, 2, 0, 0, 0}, {1488, 172, 16, 16, 0, 0, 0}}
#endif

#include "../protocol.h"

#define MAVLINK_ENABLED_MY_DIALECT_NEW
...
#include "./mavlink_msg_debug_request.h"
#include "./mavlink_msg_debug_transmit.h"
#include "./mavlink_msg_debug_set.h"
#include "./mavlink_msg_debug_do.h"
#include "./mavlink_msg_skynet.h"

// base include



#if MAVLINK_MY_DIALECT_NEW_XML_HASH == MAVLINK_PRIMARY_XML_HASH
# define MAVLINK_MESSAGE_INFO {MAVLINK_MESSAGE_INFO_HEARTBEAT, MAVLINK_MESSAGE_INFO_COMMAND_LONG, MAVLINK_MESSAGE_INFO_DEBUG_REQUEST, MAVLINK_MESSAGE_INFO_DEBUG_TRANSMIT, MAVLINK_MESSAGE_INFO_DEBUG_SET, MAVLINK_MESSAGE_INFO_DEBUG_DO, MAVLINK_MESSAGE_INFO_SKYNET}
# define MAVLINK_MESSAGE_NAMES {{ "COMMAND_LONG", 76 }, { "DEBUG_DO", 103 }, { "DEBUG_REQUEST", 100 }, { "DEBUG_SET", 102 }, { "DEBUG_TRANSMIT", 101 }, { "HEARTBEAT", 0 }, { "SKYNET", 1488 }}
...
#endif // __cplusplus
#endif // MAVLINK_MY_DIALECT_NEW_H
